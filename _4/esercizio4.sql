/* Per praticità, le tabelle degli ingredienti e dei pasti sono stati riportati anche in questo esercizio.*/
/* Le tracce degli esercizi partono dalla riga n.51*/
...
SELECT NAME, PRICE FROM MEALS WHERE PRICE < 15;     /* Creazione schema */

SELECT NAME, PRICE FROM CHEAP_MEALS;        /* Creazione query */
...
SELECT * FROM INGREDIENTS WHERE VEGAN;      /* Creazione schema */

SELECT * FROM VEGAN_INGREDIENT;     /* Creazione query */
...
SELECT NAME, PRICE FROM EXPENSIVE_MEAL;     /* Creazione query */
...
SELECT NAME, LACTOSE_FREE FROM INGREDIENTS WHERE LACTOSE_FREE;      /* Creazione schema */

SELECT NAME, LACTOSE_FREE FROM LACTOSE_FREE_INGREDIENT;     /* Creazione query */
...
SELECT NAME, CALORIES FROM MEALS WHERE CALORIES > 650;      /* Creazione schema */

SELECT NAME, CALORIES FROM HIGH_CALORIE_MEAL;       /* Creazione query */